...
AnyResponse: TypeAlias = OrderResponse | OrderAdminResponse | BookResponse | UserResponse | AuthorResponse


def assert_response_data(response_data: dict, model: type[AnyModel], response_schema: type[AnyResponse]) -> None:
